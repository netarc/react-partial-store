...
var Dataset = _.defineClass(MixinResolvable, {
  ...
  createDataset: function() {
    var self = this
      , dataset = RPS.createDataset.apply(null, arguments);
    dataset.parent = this;

    // _.each(arguments, function(item) {
    //   console.info("createDataset found item: %o", item);
    //   if (item instanceof RPS.createStore.prototype ||
    //       item instanceof RPS.createDataset.prototype) {
    //     console.info("  * was store/dataset");
    //     _.each(item, function(method, methodName) {
    //       console.info("  * checking method %s", methodName);
    //       if (method instanceof RPS.createStore.prototype ||
    //           method instanceof RPS.createDataset.prototype) {
    //         console.info("  * cloning %o", method);
    //         var aliasMethod = dataset[methodName] = RPS.createDataset(method.definition);
    //         aliasMethod.parent = self;
    //       }
    //     });
    //   }
    // });
