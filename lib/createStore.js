var RPS = require("./index")
  ...
  , MixinScopable = require('./MixinScopable')
 ...
 */
var Store = _.defineClass(MixinResolvable, MixinSubscribable, MixinScopable, {
...
function createStore(type, definition) {
  ...
  if (type) {
    ...
    // get a chance to be created; so we allow a store to be created and overided when it is a shadow.
      ...
      // TODO: This came about from scopable, is this ok?
      return RPS.createDataset(store);
